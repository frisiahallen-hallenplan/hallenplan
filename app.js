...
document.querySelector('#recurringInput').addEventListener('change', toggleRecurrence); document.querySelector('#previousWeek').addEventListener('click', () => { const view = document.querySelector('#viewSelect').value; currentDate = view === 'month' ? new Date(currentDate.getFullYear(), currentDate.getMonth() - 1, 1) : addDays(currentDate, -7); render(); }); document.querySelector('#nextWeek').addEventListener('click', () => { const view = document.querySelector('#viewSelect').value; currentDate = view === 'month' ? new Date(currentDate.getFullYear(), currentDate.getMonth() + 1, 1) : addDays(currentDate, 7); render(); }); document.querySelector('#todayButton').addEventListener('click', () => { currentDate = startOfDay(new Date()); render(); }); document.querySelector('#viewSelect').addEventListener('change', render); hallFilter.addEventListener('change', render); document.querySelector('#helpButton').addEventListener('click', () => toast('Die Termine werden über Google Sheets verwaltet.'));
...
if (window.matchMedia('(max-width: 650px)').matches) document.querySelector('#viewSelect').value = 'day';
